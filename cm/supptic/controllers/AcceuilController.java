...
public class AcceuilController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image img1 = new Image(getClass().getResource("../icons/Plus Math_15px.png").toString());
        ImageView img11 = new ImageView(img1);
        img11.setFitHeight(15);
        img11.setFitHeight(15);
        Image img2 = new Image(getClass().getResource("../icons/logout.png").toString());
        ImageView img22 = new ImageView(img2);
        img22.setRotate(180);
        Image img3 = new Image(getClass().getResource("../icons/Settings.png").toString());
        ImageView img33 = new ImageView(img3);
        nodeListe.getStylesheets().add(getClass().getResource("../styles/styleNodeList.css").toExternalForm());
